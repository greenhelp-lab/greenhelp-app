...
<body data-is-admin="<?= $is_admin ? '1' : '0' ?>">
      ...
      <section class="detail-main">
        ...
        <aside class="detail-aside">
          <div class="aside-card">
            ...
            <div class="cta-area">
              <button class="btn-add-cart btn-primary btn-hire" data-id="<?= htmlspecialchars($servico_id) ?>">
  ...
  <script src="<?php echo BASE_URL; ?>/public/js/marketplace/sobre_servico.js"></script>
</body>
